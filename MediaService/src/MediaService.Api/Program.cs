...
// CHI con MOT hang doi: media.meeting-invite, cho viec moi ban be truc tiep
// (UC-32). Identity Service consume no roi day thong bao xuong nguoi duoc moi
// qua WebSocket - Identity la dau moi notification cua ca he thong.
//
// Hang doi media.meeting-created cua ban truoc da bo han: mo hop trong nhom
// da tao san mot tin nhan he thong ngay trong khung chat cua nhom do, ca nhom
// thay ngay - them mot duong bao thu hai chi la bao trung.
